...
The basics this document covers are:
...
In order to learn the basics, you'll need a computer with R and RStudio installed. If you need to install these, it's very easy. Either use the following links or use google to find them:
