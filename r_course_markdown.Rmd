...
Welcome! Today we're going to look at the principles of shaping data in preparation for visualising in **ggplot**. The first principle is: **shaping the data is an essential part of building visualisations**. It's not just an annoyance: your visualisation goals will dictate the kind of shape the data needs to be made into.
